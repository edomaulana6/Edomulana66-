...
async def search_download_callback(update: Update, context: CallbackContext):
    ...
    # We don't delete the message here, just acknowledge by editing it slightly
    # This keeps the "back to list" button functional
    ...
    # Re-display the download choice to allow another download or go back
    await _display_download_choice(update, context)
    return CHOOSE_FORMAT
